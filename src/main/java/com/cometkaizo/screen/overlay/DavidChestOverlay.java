...
public class DavidChestOverlay extends Overlay {
    ...
    public DavidChestOverlay(GameApp app, Runnable openHeartAction, Overlay prev) {
        ...
        keyhole = new ImageClickable(this.app, this::openHeart, w -> w/2 - 9, h -> h/2 - 22, _ -> 16, _ -> 16, () -> "gui/sculpture/david/keyhole", 0, 0);
    }

    public void openHeart() {
        // todo: do a check for key item in cursor here
        openHeartAction.run();
        heartOpen = true;
    }
